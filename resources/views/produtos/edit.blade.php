<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-purple-500">Produtos</p>
                <h2 class="text-2xl font-bold text-gray-900" style="font-family:'Playfair Display',serif;">Editar Produto</h2>
            </div>
        </div>
    </x-slot>
    ...
    <style>
        ...
        .field-input:focus{border-color:#9333ea;background:#fff;box-shadow:0 0 0 4px rgba(147,51,234,.08);}
        ...
        .field-group:focus-within .field-icon{color:#9333ea;}
    ...
    <div class="py-10 dm">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="form-wrap flex items-center gap-3 px-1 mb-4">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-800">{{ $produto->nome }}</p>
                    <p class="text-xs text-gray-400">Editando produto{{ $produto->codigo ? ' · ' . $produto->codigo : '' }}</p>
                </div>
            </div>

            <div class="form-wrap bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden" style="animation-delay:.05s">
                <div class="h-1.5 bg-gradient-to-r from-purple-500 to-violet-500"></div>
                <div class="p-8">
                    <form action="{{ route('produtos.update', $produto->id) }}" method="POST" class="space-y-5">
                        @csrf @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" name="nome" value="{{ old('nome', $produto->nome) }}" class="field-input" required>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="codigo" value="{{ old('codigo', $produto->codigo) }}" class="field-input">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="categoria" value="{{ old('categoria', $produto->categoria) }}" class="field-input">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-group">
                                ...
                                <textarea name="descricao" class="field-input" rows="3">{{ old('descricao', $produto->descricao) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="number" name="preco" value="{{ old('preco', $produto->preco) }}" class="field-input" step="0.01" min="0" required>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="number" name="estoque_minimo" value="{{ old('estoque_minimo', $produto->estoque_minimo) }}" class="field-input" min="0" required>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="unidade" value="{{ old('unidade', $produto->unidade) }}" class="field-input" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-group">
                                ...
                                <select name="status" class="field-input" required>
                                    @php $cur = old('status', $produto->status); @endphp
                                    <option value="ativo"   {{ $cur === 'ativo'   ? 'selected' : '' }}>Ativo</option>
                                    <option value="inativo" {{ $cur === 'inativo' ? 'selected' : '' }}>Inativo</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-group">
                                <div class="field-icon textarea-icon"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7"/></svg></div>
                                <textarea name="observacoes" class="field-input" rows="2">{{ old('observacoes', $produto->observacoes) }}</textarea>
                            </div>
                        </div>

                        <div class="flex items-center justify-between pt-2">
                            <a href="{{ route('produtos.index') }}" class="text-sm text-gray-400 hover:text-gray-600 font-medium transition">← Cancelar</a>
                            <button type="submit" class="inline-flex items-center gap-2 px-6 py-2.5 bg-purple-600 text-white text-sm font-semibold rounded-full hover:bg-purple-700 transition-all duration-300 shadow-md hover:shadow-purple-200 active:scale-95">
