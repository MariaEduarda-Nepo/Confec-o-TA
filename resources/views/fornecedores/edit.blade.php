<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-indigo-500">Fornecedores</p>
                <h2 class="text-2xl font-bold text-gray-900" style="font-family:'Playfair Display',serif;">Editar Fornecedor</h2>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="form-wrap flex items-center gap-3 px-1 mb-4">
                <div class="w-9 h-9 bg-indigo-600 rounded-xl flex items-center justify-center">
                    <span class="text-white font-bold text-sm" style="font-family:'Playfair Display',serif;">{{ strtoupper(substr($fornecedor->nome, 0, 1)) }}</span>
                </div>
                <div>
                    <p class="text-sm font-semibold text-gray-800">{{ $fornecedor->nome }}</p>
                    <p class="text-xs text-gray-400">Editando fornecedor</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('fornecedores.update', $fornecedor->id) }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" name="nome" value="{{ old('nome', $fornecedor->nome) }}" class="field-input" required>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" name="cnpj" value="{{ old('cnpj', $fornecedor->cnpj) }}" class="field-input" required>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $fornecedor->email) }}" class="field-input" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="telefone" value="{{ old('telefone', $fornecedor->telefone) }}" class="field-input" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" name="endereco" value="{{ old('endereco', $fornecedor->endereco) }}" class="field-input" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="cep" value="{{ old('cep', $fornecedor->cep) }}" class="field-input" required>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="cidade" value="{{ old('cidade', $fornecedor->cidade) }}" class="field-input" required>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="estado" value="{{ old('estado', $fornecedor->estado) }}" class="field-input" maxlength="2" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="field-group">
                                ...
                                <textarea name="observacoes" class="field-input" rows="3">{{ old('observacoes', $fornecedor->observacoes) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-2">
                            ...
                            <button type="submit" class="inline-flex items-center gap-2 px-6 py-2.5 bg-indigo-600 text-white text-sm font-semibold rounded-full hover:bg-indigo-700 transition-all duration-300 shadow-md hover:shadow-indigo-200 active:scale-95">
