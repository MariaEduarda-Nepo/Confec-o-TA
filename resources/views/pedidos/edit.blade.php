                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="data_pedido" id="data_pedido"
                                   value="{{ old('data_pedido', \Carbon\Carbon::parse($pedido->data_pedido)->format('Y-m-d\TH:i')) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="observacoes" id="observacoes" rows="3"
                                      class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 @error('observacoes') border-red-500 @enderror">{{ old('observacoes', $pedido->observacoes) }}</textarea>
